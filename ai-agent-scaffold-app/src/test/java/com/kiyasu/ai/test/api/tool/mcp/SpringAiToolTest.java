package com.kiyasu.ai.test.api.tool.mcp;
...
public class SpringAiToolTest {
    ...
    public static McpSyncClient sseMcpClient() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com")
                .sseEndpoint("/v2/ai_search/mcp/sse?api_key=bce-v3/ALTAK-4obpT3OGHUjAljfHOePNB/6dd2402bbbf0823fc50dd7b87cca45a765837d6e")
                .build();
    ...
    public void test_url() throws MalformedURLException {
        ...
        String fullUrl = "http://appbuilder.baidu.com/v2/ai_search/mcp/sse?api_key=bce-v3/ALTAK-4obpT3OGHUjAljfHOePNB/6dd2402bbbf0823fc50dd7b87cca45a765837d6e";
